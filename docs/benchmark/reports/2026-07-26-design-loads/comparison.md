...
| Metrics warned | 1 |
| Metrics failed | 43 |
| Metrics not applicable | 56 |
| Required metrics compared | 92 of 148 |
| Required metrics unavailable | 56 |
...
- 56 of 148 required metrics were unavailable on at least one side (reported as N/A, never as a numerical failure).
...
| Weather | HUN_CEN_Budapest.Met.Center.128400_TMYx | HUN_CEN_Budapest.Met.Center.128400_TMYx |
| Design-day source | EmbeddedModel | EmbeddedModel |
...
| peakHeatingLoad | kW | 3.93393212890625 | 5.720615732872154 | 1.7866836039659035 | 31.23236531513824 | Fail | informational (excluded from the numerical status) |
| peakHeatingHour | hourOfYear | 919 | 775 | 144 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
| peakCoolingLoad | kW | 0 | 0.0402250938503556 | 0.0402250938503556 | 100 | Fail | informational (excluded from the numerical status) |
| peakCoolingHour | hourOfYear | 0 | 7974 | 786 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 0872cd39962f43c3b62a6e031a76c24a | Guid | heating.designLoad | W | 574.0481567382812 | 1132.105378358097 | 558.0572216198157 | 49.29375235626663 | Fail |  |
...
| 0872cd39962f43c3b62a6e031a76c24a | Guid | heating.peakHour | hourOfYear | 1441 | 919 | 522 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 13a0403ab3a543608613b0ce9bf52d92 | Guid | heating.designLoad | W | 199.83349609375 | 132.9146643279224 | 66.9188317658276 | 33.48729470980844 | Fail |  |
...
| 13a0403ab3a543608613b0ce9bf52d92 | Guid | heating.peakHour | hourOfYear | 1441 | 918 | 523 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 312fab2f1ba64756b47ccc3dcb21ac8a | Guid | heating.peakHour | hourOfYear | 1441 | 0 | 1441 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 354b8786b4714f3c9941cec051a93361 | Guid | heating.designLoad | W | 137.82980346679688 | 241.94985081273356 | 104.12004734593668 | 43.03373074882547 | Fail |  |
...
| 354b8786b4714f3c9941cec051a93361 | Guid | heating.peakHour | hourOfYear | 1441 | 919 | 522 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 6e7ef8487b714da3b730e0f226af927e | Guid | heating.designLoad | W | 379.9020080566406 | 237.9464743064166 | 141.95553375022402 | 37.36635520206555 | Fail |  |
...
| 6e7ef8487b714da3b730e0f226af927e | Guid | heating.peakHour | hourOfYear | 1442 | 919 | 523 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 7ee49aac87b24671bb00ed1b291806a1 | Guid | heating.designLoad | W | 366.3569641113281 | 170.60334873223655 | 195.75361537909157 | 53.43248103770348 | Fail |  |
...
| 7ee49aac87b24671bb00ed1b291806a1 | Guid | heating.peakHour | hourOfYear | 1444 | 919 | 525 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| 8d2d2a0234584fe4b171e5a9373f1b4d | Guid | heating.designLoad | W | 69.23214721679688 | 42.95932098398786 | 26.272826232809017 | 37.9488825480698 | Fail |  |
...
| 8d2d2a0234584fe4b171e5a9373f1b4d | Guid | heating.peakHour | hourOfYear | 1452 | 774 | 678 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| affc43b0b5b3445f85d5cea8a7b88d4f | Guid | heating.designLoad | W | 204.9483642578125 | 128.39770298313388 | 76.55066127467862 | 37.35119406875703 | Fail |  |
...
| affc43b0b5b3445f85d5cea8a7b88d4f | Guid | heating.peakHour | hourOfYear | 1447 | 774 | 673 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| c7df54b3c0064fc5a7c6e6012dbb9b8e | Guid | heating.designLoad | W | 1065.076171875 | 1826.2977051410624 | 761.2215332660624 | 41.68113068987655 | Fail |  |
...
| c7df54b3c0064fc5a7c6e6012dbb9b8e | Guid | heating.peakHour | hourOfYear | 1443 | 775 | 668 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| d8294f2a30b445ca9f6ba83c8dcf4903 | Guid | heating.designLoad | W | 564.768798828125 | 917.4634857295723 | 352.6946869014473 | 38.44236772224046 | Fail |  |
...
| d8294f2a30b445ca9f6ba83c8dcf4903 | Guid | heating.peakHour | hourOfYear | 1441 | 727 | 714 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
...
| d94f4dbee3d24ff1bcb341e2c5c6ec6d | Guid | heating.designLoad | W | 549.6607055664062 | 909.1363260313252 | 359.47562046491896 | 39.540342869605325 | Fail |  |
...
| d94f4dbee3d24ff1bcb341e2c5c6ec6d | Guid | heating.peakHour | hourOfYear | 1457 | 919 | 538 |  | Fail | circular hour difference; informational (excluded from the numerical status) |
